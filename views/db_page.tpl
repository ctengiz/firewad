    ...
    <div class="col-md-5">
        <ul class="list-group">
            <li class="list-group-item"><div class="row">
                <div class="col-md-6 text-right">Server</div>
                <div class="col-md-6 text-right">{{appconf.db_config[db]['db_server']}}</div>
            </div></li>
            <li class="list-group-item"><div class="row">
            ...
            <li class="list-group-item"><div class="row">
                <div class="col-md-6 text-right">DB Path</div>
                <div class="col-md-6 text-right">{{appconf.db_config[db]['db_path']}}</div>
            </div></li>
            <li class="list-group-item"><div class="row">
