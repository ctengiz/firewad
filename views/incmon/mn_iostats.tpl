<div class="panel panel-default">
    ...
    <div id="tbl-iostats-{{table_id}}" class="panel-collapse collapse {{'' if collapsed else 'in'}}">
        <table class="table table-bordered table-condensed text-right" style="background-color: #ffffff;">
            <tr>
                <th class="text-right">Max. Memory Used</th><td class="text-right">{{'{:,}'.format(data.max_memory_used)}}</td>
                ...
                </th><td class="text-right" >{{'{:,}'.format(data.max_memory_allocated )}}</td>
                ...
                </th><td class="text-right">{{'{:,}'.format(data.fetches)}}</td>
                ...
                </th><td class="text-right">{{'{:,}'.format(data.reads)}}</td>
            ...
            <tr>
                ...
                </th><td class="text-right">{{'{:,}'.format(data.memory_used)}}</td>
                ...
                </th><td class="text-right">{{'{:,}'.format(data.memory_allocated )}}</td>

                <td style="border: none;"></td>

                <th class="text-right">Page Write Count
                    <!--<a href="#" data-toggle="tooltip" title="Number of records read sequentially."><i class="fa fa-info-circle"></i></a>-->
                </th><td class="text-right">{{'{:,}'.format(data.writes)}}</td>
                <th class="text-right">Pages Changes Pending
                    <!--<a href="#" data-toggle="tooltip" title="Number of records read via an index"><i class="fa fa-info-circle"></i></a>-->
                </th><td class="text-right">{{'{:,}'.format(data.marks)}}</td>
            </tr>
            ...
            <tr>
                <th class="text-right">Sequential Reads
                    <a href="#" data-toggle="tooltip" title="Number of records read sequentially."><i class="fa fa-info-circle"></i></a>
                </th><td class="text-right">{{'{:,}'.format(data.seq_reads)}}</td>
                <th class="text-right">Indexed Reads
                    <a href="#" data-toggle="tooltip" title="Number of records read via an index"><i class="fa fa-info-circle"></i></a>
                </th><td class="text-right">{{'{:,}'.format(data.idx_reads)}}</td>
            ...
            <tr>
                ...
                </th><td class="text-right">{{'{:,}'.format(data.inserts)}}</td>
                ...
                </th><td class="text-right">{{'{:,}'.format(data.updates)}}</td>
            ...
            <tr>
                ...
                </th><td class="text-right">{{'{:,}'.format(data.deletes)}}</td>
