<div class="panel panel-default">
    <div class="panel-heading">
        <h4 class="panel-title">
            <a class="accordion-toggle collapsed" data-toggle="collapse" href="#tbl-dependents-{{tbl.name}}">
                <i class="fa fa-reply"></i> Dependents
            </a>
        </h4>
    </div>
    <div id="tbl-dependents-{{tbl.name}}" class="panel-collapse collapse">
